...
public class Spicejet_Enroll {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("(//div[@class='css-1dbjc4n r-1awozwy r-18u37iz r-1wtj0ep'])[3]")).click();
			...
			driver.findElement(By.xpath("//input[@placeholder='e.g. 9876-453-010']")).sendKeys("8123994444");
		...
		//input Email
		driver.findElement(By.xpath("//input[@placeholder='johndoe@example.com']")).sendKeys("jl4wrence12674@gmail.com");
			driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
...
=======
		//quit 2
>>>>>>> parent of 602d42b... Update Spicejet_Enroll.java quit 3
		//driver.quit();
	}
